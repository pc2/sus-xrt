...
#set_property description    {Control Signals} [ipx::get_registers IN_A -of_objects [ipx::get_address_blocks reg0 -of_objects [ipx::get_memory_maps s_axi_control -of_objects [ipx::current_core]]]]
...
#set_property description    {Control Signals} [ipx::get_registers IN_B -of_objects [ipx::get_address_blocks reg0 -of_objects [ipx::get_memory_maps s_axi_control -of_objects [ipx::current_core]]]]
...
#set_property description    {Control Signals} [ipx::get_registers OUT_C -of_objects [ipx::get_address_blocks reg0 -of_objects [ipx::get_memory_maps s_axi_control -of_objects [ipx::current_core]]]]
...
package_xo -xo_path ../axi_stream_example.xo -kernel_name axi_stream_example -ctrl_protocol ap_ctrl_none -ip_directory ./axi_stream_example_ip -output_kernel_xml ../axi_stream_example.xml
